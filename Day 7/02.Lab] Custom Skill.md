   ...
   module.exports = async function (context, req) {
       ...
       if (req.body && req.body.values) {
           ...
           for (rec in vals) {
               ...
               resVal.data.text = topWords.slice(0,9).map(v => v[0]);
...
4. 함수 저장 후 **Test/Run** 탭 열기 → 다음 JSON 입력:
   ...
   ```json
   {
     "values": [
       {
         "recordId": "a1",
         "data": { "text": "Tiger, tiger burning bright in the darkness of the night.", "language": "en" }
       },
       {
         "recordId": "a2",
         "data": { "text": "The rain in spain stays mainly in the plains! That's where you'll find the rain!", "language": "en" }
       }
     ]
   }
   ```
